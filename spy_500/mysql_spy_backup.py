...
def mysql_spy(date_list, time_list, open_list, high_list, low_list, price_list, sign_list, change_list, uprate_list, volume_list, kodate_list, kotime_list):
    ...
    try:
        ...
        for i in range(len(date_list)):
            ...
            VALUE
            ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})
            '''.format(str(date_list[i]), str(time_list[i]),str(open_list[i]),str(high_list[i]), str(low_list[i]), str(price_list[i]),str(sign_list[i]),str(change_list[i]),str(uprate_list[i]),str(volume_list[i]),str(kodate_list[i]), str(kotime_list[i]))
            # print(test)
